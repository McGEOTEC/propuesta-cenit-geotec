# Script to build the master MIX index.html
...
/* ============================================================
   ...
   Versión MIX: Máxima Dinámica, Parallax, Paleta GEOTEC Oficial,
   Logo de Esquina Integrado, Fichas Técnicas y Marquee de Clientes.
   ============================================================ */
:root {
  ...
  --shadow-glow: 0 0 40px rgba(146, 165, 61, 0.28);
...
/* ============================================================
   ELEMENTOS GRÁFICOS INSTITUCIONALES (Guía PPTX)
   ============================================================ */
...
/* ============================================================
   HERO / PORTADA DINÁMICA (Con Logo en Esquina & Parallax)
   ============================================================ */
.hero-section {
  position: relative;
...
.hero-corner-art img {
  ...
  height: 100%;
  object-fit: contain;
  filter: drop-shadow(0 20px 40px rgba(146, 165, 61, 0.22));
  animation: floatSlow 8s ease-in-out infinite alternate;
}

@keyframes floatSlow {
  0% { transform: translateY(0) rotate(0deg); }
  100% { transform: translateY(-14px) rotate(2.5deg); }
}
...
/* ============================================================
   SECCIÓN: EL CICLO GEOTEC Y LAS 5 CERTEZAS
   ============================================================ */
.section-certezas {
  padding: 95px 0;
  background-color: var(--blanco);
...
/* ============================================================
   SECCIÓN: 5 LÍNEAS FUNCIONALES INNOLAB (Fichas Técnicas)
   ============================================================ */
.section-lineas {
  padding: 95px 0;
  background-color: var(--hueso);
...
/* ============================================================
   SECCIÓN: ESCALAMIENTO EN 4 FASES (Timeline Exacto)
   ============================================================ */
...
/* ============================================================
   SECCIÓN: CASOS REALES & CAPACIDADES EN OPERACIÓN
   ============================================================ */
.section-casos {
...
/* ============================================================
   SECCIÓN: CTA INSTITUCIONAL & CONTACTO (Registro B)
   ============================================================ */
.section-cta {
  padding: 100px 0;
...
<!-- ============================================================
     SECCIÓN 1: INICIO / HERO DINÁMICO (Logo en Esquina & Parallax)
     ============================================================ -->
<section id="inicio" class="hero-section">
  <!-- Arte del Isotipo en Esquina con Parallax -->
  <div class="hero-corner-art" id="heroCornerArt">
    <img src="assets/geotec_corporate_book_cover.png" alt="Isotipo GEOTEC Territorial">
  </div>
  ...
  <div class="container hero-grid">
    <div class="hero-content">
      <div class="hero-pretitle">
        ...
        <span class="hero-coord-chip">MAGNA-SIRGAS // CENIT-ECOSYSTEM</span>
      </div>
    ...
    <!-- Badges Flotantes de Esquina -->
    <div class="hero-corner-badges">
      <div class="hero-badge-pill">
        <span class="hero-badge-title">Estrategia</span>
        <div class="hero-badge-text">Conocimiento · Soluciones Sostenibles</div>
      </div>

      <div class="hero-badge-pill">
        <span class="hero-badge-title">Impacto</span>
        <div class="hero-badge-text">Personas · Naturaleza · Decisiones</div>
      </div>

      <div class="hero-badge-pill">
        <span class="hero-badge-title">Propósito</span>
        <div class="hero-badge-text">Territorios que Perduran</div>
      </div>
    </div>
  </div>
</section>
...
<!-- ============================================================
     SECCIÓN 5: ESCALAMIENTO EN CUATRO FASES (Timeline Exacto)
     ============================================================ -->
...
<!-- ============================================================
     JAVASCRIPT INTERACTIVO (Con Parallax y Marquee Dinámico)
     ============================================================ -->
<script>
...
// Parallax interactivo con el mouse en el Hero
document.addEventListener('mousemove', (e) => {
  const cornerArt = document.getElementById('heroCornerArt');
  if (!cornerArt) return;
  const x = (window.innerWidth - e.pageX * 2) / 90;
  const y = (window.innerHeight - e.pageY * 2) / 90;
  cornerArt.style.transform = `translate(${x}px, ${y}px)`;
});

// Preloader Intro Motion Event
window.addEventListener('load', () => {
  const reduceMotion = window.matchMedia('(prefers-reduced-motion: reduce)').matches;
  const introDelay = reduceMotion ? 0 : 1300;
  setTimeout(() => {
...
print("Master MIX index.html written successfully. Size:", len(html_content))
