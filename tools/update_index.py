# Script to build the updated index.html
import os
...
/* Carrusel Fotográfico Corporativo */
.carousel-wrapper {
  margin-top: 30px;
  background: var(--caja-beige);
  border: 1px solid var(--gris-linea);
...
<!-- ============================================================
     SECCIÓN 7: CASOS REALES COMPROBADOS (Corporate Book 2026)
     ============================================================ -->
  ...
  <div class="container">
    ...
    <div class="carousel-wrapper">
      <div class="carousel-title-row">
        <h4>Evidencia y Respaldo en Operación</h4>
        <span class="tag-institucional">Sede Central & Campo</span>
      </div>

      <div class="carousel-slider-box">
        <div class="carousel-track" id="carouselTrack">
          <div class="carousel-slide-item">
            <img src="assets/campo_verificacion_humedal.jpg" alt="Verificación técnica en campo">
            <div class="carousel-slide-caption">
              <h5>Verificación en Terreno y Línea Base</h5>
              <p>Especialistas bióticos y geoespaciales validando cruces de infraestructura y determinantes ambientales.</p>
            </div>
          </div>

          <div class="carousel-slide-item">
            <img src="assets/oficina_fachada_calle.jpg" alt="Sede Corporativa GEOTEC">
            <div class="carousel-slide-caption">
              <h5>Sede Corporativa GEOTEC — Bogotá D.C.</h5>
              <p>Centro de operaciones e ingeniería con infraestructura tecnológica propia y servidores dedicados.</p>
            </div>
          </div>
          ...
          <div class="carousel-slide-item">
            ...
            <div class="carousel-slide-caption">
              <h5>Capacidad Instalada e Interdisciplinaria</h5>
              <p>Equipo de especialistas en SIG, modelación ambiental, derecho regulatorio y desarrollo de software.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="carousel-controls">
        <button class="carousel-btn" onclick="prevSlide()" aria-label="Anterior">‹</button>
        <div class="carousel-dots" id="carouselDots">
          <div class="carousel-dot active" onclick="goToSlide(0)"></div>
          <div class="carousel-dot" onclick="goToSlide(1)"></div>
          <div class="carousel-dot" onclick="goToSlide(2)"></div>
        </div>
        <button class="carousel-btn" onclick="nextSlide()" aria-label="Siguiente">›</button>
      </div>
    </div>
  </div>
</section>
...
// Auto-avance de carrusel cada 6 segundos
...
carouselWrap.addEventListener('mouseleave', () => carouselTimer = setInterval(nextSlide, 6000));
...
print("Updated index.html successfully. Size:", len(html_content))
